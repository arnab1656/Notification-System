...
// Creating a new role using the function...
...
// Get roles based on parameters using the function...
...
// Get a single role based on parameters using the function...
...
// Get role claims based on parameters using the function...
...
// Delete role claims based on parameters using the function...
...
export const getById = async (id: string) => {
    // MongoDB uses string IDs by default
    try {
